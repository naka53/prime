...
\end{center}
On peut aussi noter que ATRA peut être faite en modifiant la valeur des PGD, cependant cela ne rend pas l'attaque complète car chaque processus a son propre PGD. Pour la rendre complète il faudrait donc faire la modification pour tous les PGD.
...
\\
Nous pouvons aussi voir qu'il existe des failles au sein de la mémoire elle même. Cependant elles restent compliquées à exploiter aux vues du manque de documentation et la complexités des codes linux gérant la mémoire.
