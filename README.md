...
prime is a simple kernel rootkit (Linux Kernel x86) that look for sys_call_table offset from code in memory. More pricisely, he is looking at the syscall routine code. Moreover he is able to hide file/process to user that match with a MAGIC_PREFIX.
